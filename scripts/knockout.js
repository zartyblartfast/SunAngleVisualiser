        ...
        (function (n) {
            ...
            a.a = (function () {
                ...
                return {
                    ...
                    ec: function (b, c) {
                        for (
                            var d = a.a.V(b.getElementsByTagName("input")).concat(a.a.V(b.getElementsByTagName("textarea"))),
                                e =
                                    "string" == typeof c
                                        ? function (a) {
                                              return a.name === c;
                        ...
                        if (e && !k) {
                            ...
                            switch (c) {
                                ...
                                case "splice":
                                    ...
                                    for (var g = 1 === t ? g : Math.min(c + (d[1] || 0), g), t = c + t - 2, G = Math.max(g, t), P = [], n = [], Q = 2; c < G; ++c, ++Q)
                    ...
                    if (d) {
                        ...
                        for (var A = 0, y; (y = d[A]); ++A) {
                            ...
                            if (44 === t) {
                                ...
                                47 === t && A && 1 < y.length
                                    ? (t = d[A - 1].match(f)) && !g[t[0]] && ((b = b.substr(b.indexOf(y) + 1)), (d = b.match(e)), d.push(","), (A = -1), (y = "/"))
                                    : 40 === t || 123 === t || 91 === t
                                    ? ++p
                                    : 41 === t || 125 === t || 93 === t
                                    ? --p
                ...
                update: function (b, c, d) {
                    ...
                    a.l.w(function () {
                        h
                            ...
                            : (k ? p.length && e().length < p.length : p.length && 0 <= b.selectedIndex ? a.j.u(b.options[b.selectedIndex]) !== p[0] : p.length || 0 <= b.selectedIndex) && a.a.Da(b, "change");
                    });
                    a.a.Nc(b);
                ...
                a.d.textInput = {
                    init: function (b, d, g) {
                        ...
                        10 > a.a.C
                            ...
                            : (l("input", t), 5 > e && "textarea" === a.a.A(b) ? (l("keydown", y), l("paste", y), l("cut", y)) : 11 > c ? l("keydown", y) : 4 > f && (l("DOMAutoComplete", t), l("dragdrop", t), l("drop", t)));
                        l("change", t);
                        a.m(k, null, { i: b });
                    },
                };
